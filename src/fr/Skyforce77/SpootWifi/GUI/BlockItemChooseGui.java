...
public class BlockItemChooseGui extends GenericPopup {
	
	public BlockItemChooseGui(String title, SpoutPlayer sp, ItemStack item)
	{
		...
		pcent.setText(">>");
		ConfigurableCheckBox check = new ConfigurableCheckBox();
		check.setText("Auto channel");
		if(ItemSave.getOption(item, "AutoChannel") == 1)
		{
